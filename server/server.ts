...
let fallbackSessions: Record<string, string> = {}; // token -> userId
...
// Clean Mongo document to remove _id and sensitive fields
...
async function startServer() {
  ...
  // ==========================================
  // AUTHENTICATION ROUTES (Mobile Number + Password)
  // ==========================================
  ...
  // ==========================================
  // DATA ROUTES (Products, Employees, Ledger, Dispatch)
  // ==========================================
  ...
  // Full Database State (User-Scoped)
  ...
  // Dispatch Assignment (User-Scoped)
  ...
  // Delete Ledger Entry (User-Scoped)
  ...
  // Delete Dispatch Record (User-Scoped)
